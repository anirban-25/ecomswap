...
import { Settings, ListAlt, ExitToApp, Person, Search, Edit } from '@mui/icons-material';
...
const Page: React.FC<Props> = () => {
  ...
  const rows: GridRowsProp = [
    { id: 801, type: 'e commerce', location: 'bombay', industry: 'backend', startdate: '30 feb', askingprice: '3333', status: 'Approved', createdat: '29feb' },
    { id: 802, type: 'garden', location: 'kolkata', industry: 'politics', startdate: '20 feb', askingprice: '222', status: 'Approved', createdat: '56 march' },
    { id: 803, type: 'anirban hater', location: 'sonarpur', industry: 'frontend', startdate: '16 july', askingprice: '222', status: 'Pending', createdat: '36 jan' },
  ];
