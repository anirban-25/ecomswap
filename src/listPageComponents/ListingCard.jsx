...
const ListingCard = ({ listing }) => {
  const { title, price, thumbnailUrl, verified, topRated, monthlyNetProfit, monthlyRevenue, trafficPercentage, type, industry, monetization } = listing;
  ...
  return (
    ...
    <div className="flex justify-between mt-2">
        ...
        <div className="flex justify-between mt-2">
        <hr style={{ width: '1170px', height: '1px', backgroundColor: '#D7D7D7', border: 'none', marginTop: '20px' }} />
        </div>
